...
var useCreateController = function (props) {
    ...
    var _b = (0, core_1.useResourceDefinition)(props), hasEdit = _b.hasEdit, hasShow = _b.hasShow;
    ...
    var _c = (0, saveContext_1.useMutationMiddlewares)(), registerMutationMiddleware = _c.registerMutationMiddleware, getMutateWithMiddlewares = _c.getMutateWithMiddlewares, unregisterMutationMiddleware = _c.unregisterMutationMiddleware;
    var _d = (0, dataProvider_1.useCreate)(resource, undefined, __assign(__assign({ onSuccess: function (data, variables, context) { return __awaiter(void 0, void 0, void 0, function () {
