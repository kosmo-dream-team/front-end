  ...
  return (
    <div className="popular-campaign">
      ...
      <div className="popular-campaign__item popular-campaign__item--second">
        ...
        <div className="popular-campaign__item-org-container">
          <div className="popular-campaign__item-org">사단법인 따뜻한 하루</div>
        </div>
        <div className="popular-campaign__item-progress-container">
          <div className="popular-campaign__item-progress popular-campaign__item-progress--second" />
        </div>
        <div className="popular-campaign__item-amount popular-campaign__item-amount--second">
          989,900원
        </div>
        <div className="popular-campaign__item-percent popular-campaign__item-percent--second">
          22%
        </div>
      </div>
      ...
      <div className="popular-campaign__item popular-campaign__item--third">
        ...
        <div className="popular-campaign__item-progress-container">
          <div className="popular-campaign__item-progress popular-campaign__item-progress--third" />
        </div>
        <div className="popular-campaign__item-amount popular-campaign__item-amount--third">
          5,519,959원
        </div>
